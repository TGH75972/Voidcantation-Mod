...
public static final ComponentType<PhaseDaggerData> PHASE_DAGGER_DATA = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of("voidcantation", "phase_dagger_data"), ComponentType.<PhaseDaggerData>builder().codec(PhaseDaggerData.CODEC).packetCodec(net.minecraft.network.codec.PacketCodecs.codec(PhaseDaggerData.CODEC)).build());
